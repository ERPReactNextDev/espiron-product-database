    ...
    <div className="max-w-lg mx-auto py-4 px-4">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <button onClick={onClose} className="p-2 rounded-lg hover:bg-gray-100 text-gray-500" style={{ minHeight: 44 }}>
          ...
          return (
            <div key={acc.id} className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm">
              ...
              <div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-gray-100">
                ...
                />
                {!acc.is_default && (
                  <AccBtn icon={<Star className="w-3.5 h-3.5" />} label="Default"
