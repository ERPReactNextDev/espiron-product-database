    ...
    <div className="flex flex-col h-full overflow-hidden select-none">
      ...
      <div className="px-2 pb-1 shrink-0 relative">
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2.5 rounded-lg hover:bg-gray-200 transition-colors text-left"
          style={{ minHeight: 44 }}
        >
        ...
        {accountSwitcherOpen && (
          <>
            <div className="fixed inset-0 z-40" onClick={() => setAccountSwitcherOpen(false)} />
            <div className="absolute left-2 right-2 mt-1 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden z-50">
              {accounts.map((acc) => (
                <button
                  key={acc.id}
