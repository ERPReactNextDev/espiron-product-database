...
export function AddAccountForm({ userId, onAdded, onCancel, isFirst }: AddAccountFormProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-xl w-full max-w-md mx-auto my-4">
      {/* Header */}
      <div className="px-5 py-4 border-b border-gray-100 sm:px-6 sm:py-5">
      ...
      <div className="px-5 py-4 space-y-4 sm:px-6 sm:py-5">
        {/* Display name */}
        <div>
      ...
      {(stage === "idle" || stage === "detecting" || stage === "saving") && (
        <div className="px-5 pb-4 flex gap-3 sm:px-6 sm:pb-5">
          {!isFirst && (
