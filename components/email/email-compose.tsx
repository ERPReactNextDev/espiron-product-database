...
export function EmailCompose({ data, accounts, userId, onClose, onSent, onChange }: EmailComposeProps) {
  ...
  const windowClass = cn(
    "fixed z-50 bg-white border border-gray-300 shadow-2xl flex flex-col",
    isMobile
      ? "inset-0 rounded-none"
      : data.is_maximized
      ? "inset-4 rounded-xl"
      : data.is_minimized
      ? "bottom-0 right-6 w-80 h-12 overflow-hidden rounded-xl"
      : "bottom-4 right-6 w-[580px] h-[540px] rounded-xl"
  );
  ...
  return (
    <div className={windowClass}>
      {/* Title bar */}
      <div className={cn(
        "flex items-center justify-between px-4 py-2.5 bg-gray-800 shrink-0 cursor-pointer",
      ...
      {!data.is_minimized && (
        <>
          ...
          {/* Footer buttons */}
          <div className={cn(
            "flex items-center justify-between px-4 py-2.5 border-t border-gray-200 bg-gray-50 shrink-0",
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span className={cn(isMobile ? "hidden" : "")}>Send</span>
              </button>
              <button
              ...
              >
                ...
                <span className={cn(isMobile ? "hidden" : "")}>Save Draft</span>
              </button>
            </div>
            <button
