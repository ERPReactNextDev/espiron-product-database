          ...
          {isMobile ? (
            <>
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-gray-200 text-gray-600 hover:bg-gray-300 transition-colors"
              >
              ...
              {showFilterMenu && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-1 bg-white border border-gray-200 rounded-xl shadow-xl py-1 min-w-[140px] z-50">
                    {filters.map((f) => (
                      <button
                        key={f.key}
                        onClick={() => { onFilterChange(f.key); setShowFilterMenu(false); }}
                        className={cn(
                          "w-full flex items-center gap-2 px-3 py-2 text-sm transition-colors text-left",
                          filter === f.key ? "bg-blue-50 text-blue-600 font-semibold" : "text-gray-700 hover:bg-gray-50"
                        )}
                      >
                        {f.label}
                      </button>
