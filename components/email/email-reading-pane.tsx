        ...
        <div className="flex items-center gap-1">
          ...
          {isMobile ? (
            <>
              ...
              <ActionBtn icon={<Star className={cn("w-4 h-4", message.is_flagged ? "fill-amber-400 text-amber-400" : "")} />} label={message.is_flagged ? "Unflag" : "Flag"} onClick={onFlag} />
              <div className="relative">
                ...
                {showActionMenu && (
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-1 bg-white border border-gray-200 rounded-xl shadow-xl py-1 min-w-[160px] z-50">
                      <ActionMenuItem icon={<ReplyAll className="w-4 h-4" />} label="Reply All" onClick={() => { onReplyAll(); setShowActionMenu(false); }} />
                      <ActionMenuItem icon={<Forward className="w-4 h-4" />} label="Forward" onClick={() => { onForward(); setShowActionMenu(false); }} />
                      <div className="h-px bg-gray-100 my-1" />
                      <ActionMenuItem icon={<Trash2 className="w-4 h-4" />} label="Delete" onClick={() => { onDelete(); setShowActionMenu(false); }} danger />
                    </div>
                  </>
                )}
              </div>
