...
export async function POST(req: NextRequest) {
  try {
    ...
    /* ΓöÇΓöÇ Resolve edited_by ΓöÇΓöÇ */
    ...
    /* ΓöÇΓöÇ Get current version number ΓöÇΓöÇ */
    ...
    /* ΓöÇΓöÇ Fetch current status ΓöÇΓöÇ */
    ...
    for (let rowIdx = 0; rowIdx < rowCount; rowIdx++) {
      ...
      for (let optIdx = 0; optIdx < rowProducts.length; optIdx++) {
        ...
        /* ΓöÇΓöÇ Carry __sellingCost/__leadTime from existing products ΓöÇΓöÇ */
    ...
    /* ΓöÇΓöÇ INSERT version history snapshot ΓöÇΓöÇ */
    ...
    /* ΓöÇΓöÇ UPDATE main spf_creation table ΓöÇΓöÇ */
    await supabase
      .from("spf_creation")
      .update({
        referenceid: effectiveReferenceId,
